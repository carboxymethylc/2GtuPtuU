...
- (id)init;
{
    ...
    [saturationFilter addTarget:selectiveFocusFilter atTextureLocation:0];
    
    // To prevent double updating of this filter, disable updates from the sharp image side
    self.initialFilters = [NSArray arrayWithObjects:saturationFilter,blurFilter, selectiveFocusFilter, nil];
...
- (void)setExcludeCirclePoint:(CGPoint)newValue;
{
    ...
    [saturationFilter setPoint:newValue forUniformName:@"excludeCirclePoint"];
}
...
- (void)setExcludeCircleRadius:(CGFloat)newValue;
{
    ...
    [saturationFilter setFloat:newValue forUniformName:@"excludeCircleRadius"];
}
