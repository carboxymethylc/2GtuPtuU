#import "GPUImageTiltShiftFilterVertical.h"
#import "GPUImageFilter.h"
#import "GPUImageTwoInputFilter.h"
#import "GPUImageGaussianBlurFilter.h"
#import "GPUImageSaturationFilter.h"

NSString *const kGPUImageTiltShiftVerticalFragmentShaderString = SHADER_STRING
( 
...
@implementation GPUImageTiltShiftFilterVertical
...
- (id)init;
{
    ...
    tiltShiftFilter = [[GPUImageTwoInputFilter alloc] initWithFragmentShaderFromString:kGPUImageTiltShiftVerticalFragmentShaderString];
    ...
    [saturationFilter addTarget:tiltShiftFilter atTextureLocation:0];
    
    // To prevent double updating of this filter, disable updates from the sharp image side
//    self.inputFilterToIgnoreForUpdates = tiltShiftFilter;
    
    self.initialFilters = [NSArray arrayWithObjects:saturationFilter,blurFilter, tiltShiftFilter, nil];
